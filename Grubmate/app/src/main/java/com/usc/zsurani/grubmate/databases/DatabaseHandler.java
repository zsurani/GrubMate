package com.usc.zsurani.grubmate.databases;
...
public class DatabaseHandler  extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_NOTIFICATION = "CREATE TABLE " + Notifications.TABLE  + "("
                ...
                + Notifications.KEY_requestorID + " INTEGER, "
                + Notifications.KEY_location + " TEXT, "
                + Notifications.KEY_postID + " INTEGER, "
